...
public class adminParticipants extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setBounds(630, 80, 150, 30);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(790, 84, 90, 20);
        ...
        if (rowIndex < 0){
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    editParti.age.setText("" +rs.getString("age"));
                    editParti.gender.setSelectedItem("" +rs.getString("Gender"));
                    editParti.partcipantsName.setText("" +rs.getString("Participants_Name"));
                    editParti.eventName.setText("" +rs.getString("Event_Name"));
                }
                rs.close(); 
                this.dispose();
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try{
            ...
            ResultSet rs = dbc.getData("SELECT participants.Id, participants.Participants_Name, event_list.Event_Name, event_list.Venue, event_list.Date, event_list.Time\n" +
                                        "FROM participants\n" +
                                        "INNER JOIN event_list ON participants.e_Id = event_list.Id WHERE Participants_Name = '"+ searchBar.getText() +"'");
            participantsList.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
        }catch(SQLException ex){
            System.out.println("Errors: "+ex.getMessage());
