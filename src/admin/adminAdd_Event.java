...
import static staff.staffEvent_Add.isInteger;
import static staff.staffEvent_Add.isValidDate;
import static staff.staffEvent_Add.isValidTime;
...
public class adminAdd_Event extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        } else if (!isInteger(amounts.getText())){
